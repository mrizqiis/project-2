                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <a href="<?php echo base_url() ?>" class="logo">
                            <img src="<?php echo base_url() ?>assets/assets_shop/img/logo2.png" alt="JSOFT">
                        </a>
                    </div>
                    <!--== Logo End ==-->
                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright">
                            <ul>
                                ...
                                <li><a href="<?php echo base_url('customer/data_mobil') ?>">PEMESANAN</a></li>

                                <?php if($this->session->userdata('nama')) { ?>

                                    <li><a href="<?php echo base_url('customer/transaksi') ?>">HISTORY</a></li>
